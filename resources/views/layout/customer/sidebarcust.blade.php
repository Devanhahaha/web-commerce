    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="{{ route('dashboardcust.index') }}">
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayanan" aria-expanded="false" aria-controls="collapseLayanan">
                    ...
                    <div class="collapse" id="collapseLayanan" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ route('pulsaCust.index') }}">Pulsa</a>
                            <a class="nav-link" href="{{ route('paket_dataCust.index') }}">Paket Data</a>
                            <a class="nav-link" href="{{ route('bayar_tagihanCust.index') }}">Bayar Tagihan</a>
                            <a class="nav-link" href="{{ route('serviceCust.index') }}">Service</a>
                        </nav>
                    </div>
                </a>
                
                <a class="nav-link" href="{{ route('productCust.index') }}">
                    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                    Product
                </a>
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseRiwayatTransaksi" aria-expanded="false" aria-controls="collapseRiwayatTransaksi">
                    <div class="sb-nav-link-icon"><svg class="svg-inline--fa fa-table-columns" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table-columns" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zm64 64V416H224V160H64zm384 0H288V416H448V160z"></path></svg><!-- <i class="fas fa-columns"></i> Font Awesome fontawesome.com --></div>
                    Riwayat Transaksi
                    <div class="sb-sidenav-collapse-arrow"><svg class="svg-inline--fa fa-angle-down" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor" d="M169.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 274.7 54.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"></path></svg><!-- <i class="fas fa-angle-down"></i> Font Awesome fontawesome.com --></div>
                </a>
                <div class="collapse" id="collapseRiwayatTransaksi" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('riwayatTransaksiPulsa.index') }}">Riwayat Transaksi Pulsa</a>
                        <a class="nav-link" href="{{ route('riwayatTransaksiPaketData.index') }}">Riwayat Transaksi Paket Data</a>
                        <a class="nav-link" href="{{ route('riwayatTransaksiBayarTagihan.index') }}">Riwayat Transaksi Bayar Tagihan</a>
                        <a class="nav-link" href="{{ route('riwayatTransaksiProduct.index') }}">Riwayat Transaksi Product</a>
                        <a class="nav-link" href="{{ route('riwayatTransaksiServices.index') }}">Riwayat Transaksi Services</a>
                    </nav>
                </div>
