...
@section('content')
            ...
            <form action="{{ route('bayar_tagihanCust.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="jenis_tagihan" name="jenis_tagihan" required>
                        ...
                        <option value="PLN" {{ old('jenis_tagihan') == 'PLN' ? 'selected' : '' }}>Tagihan Listrik PLN
                        </option>
                        <option value="BPJS" {{ old('jenis_tagihan') == 'BPJS' ? 'selected' : '' }}>Tagihan Kartu BPJS
                        </option>
                    </select>
                </div>
                <div class="mb-3">
    ...
    <script>
        function updateHarga() {
            ...
            var hargaValue = selectedOption.value;
