                        ...
                        <tbody>
                            @foreach ($productCust as $item)
                                <tr>
                                    ...
                                    <td><img src="{{ asset($item->gambar) }}" alt="gambar" style="max-width: 100px"></td>
                                    ...
                                    <td>
                                        <div class="quantity-controls">
                                            ...
                                            <button type="button" class="btn btn-success"
                                                onclick="increaseQuantity({{ $item->id }}, {{ $item->stok }})">+</button>
                                        </div>
                                    </td>
                                    <!-- Action buttons -->
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <form action="{{ route('productCust.checkout', $item->id) }}" method="POST">
                                                @csrf
                                                <input type="hidden" id="{{ $item->id . '-qty' }}" name="qty"
                                                    value="1">
